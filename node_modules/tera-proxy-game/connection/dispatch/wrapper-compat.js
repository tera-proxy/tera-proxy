...
class CompatWrapper extends ModWrapper {
	...
	hook(name, version, ...etc) { return super.hook(this[kRemap](name), version === 'event' ? 'raw' : version, ...etc) }
	hookOnce(name, version, ...etc) { return super.hookOnce(this[kRemap](name), version === 'event' ? 'raw' : version, ...etc) }
