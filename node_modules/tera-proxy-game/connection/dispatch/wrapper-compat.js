...
class CompatWrapper extends ModWrapper {
	...
	// Hooks
	hook(name, version, ...etc) { return super.hook(name, version === 'event' ? 'raw' : version, ...etc) }
	hookOnce(name, version, ...etc) { return super.hookOnce(name, version === 'event' ? 'raw' : version, ...etc) }
