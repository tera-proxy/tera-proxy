...
class CompatWrapper extends ModWrapper {
	...
	// Hooks
	hook(name, version, opts, cb) { return super.hook(name, version === 'event' ? 'raw' : version, opts, cb) }
	hookOnce(name, version, opts, cb) { return super.hookOnce(name, version === 'event' ? 'raw' : version, opts, cb) }
